...
import ExportButton from '../../../frontend/src/components/help/dashboard/ExportButton';
import * as exportUtils from '../../../frontend/src/utils/exportUtils';

// Mock de exportUtils functies
jest.mock('../../../frontend/src/utils/exportUtils', () => ({
...
describe('ExportButton Component', () => {
  ...
  it('opens the export options dialog when PDF is selected', () => {
    ...
    // Klik op de PDF optie
    fireEvent.click(screen.getByText('Exporteer als PDF'));
  ...
  it('opens the export options dialog when Excel is selected', () => {
    ...
    // Klik op de Excel optie
    fireEvent.click(screen.getByText('Exporteer als Excel'));
