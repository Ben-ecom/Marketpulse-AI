...
jest.mock('date-fns', () => ({
  format: jest.fn().mockImplementation((date, formatStr) => {
    if (formatStr === 'yyyyMMdd') {
      ...
      return '20230601'; // Default voor nieuwe Date()
    }
...
describe('Export Utils', () => {
  ...
  describe('PDF Functions', () => {
    ...
    it('adds a table to a PDF document', () => {
      const doc = exportUtils.createPdfDocument();
      // Mock de autoTable functie en previous eigenschap
  ...
  describe('Helper Functions', () => {
    it('generates a filename based on type and date range', () => {
      ...
      // Format is al gemockt in de jest.mock bovenaan
    ...
    it('generates a data summary', () => {
      ...
      expect(summary).toContain('50.0%'); // Aangepast naar 50.0% in plaats van 50%
